...
const seedData = async () => {
    try {
        ...
        const destinations = [
            { _id: "DES001", code: "DES001", name: "Sapa", description: "Thị trấn mộng mơ vùng Tây Bắc", image: "/assets/images/tours/sapa/sapa.jpg" },
            { _id: "DES002", code: "DES002", name: "Hạ Long", description: "Kỳ quan thiên nhiên thế giới", image: "/assets/images/tours/ha-long/halong.png" },
            { _id: "DES003", code: "DES003", name: "Hội An", description: "Phố cổ di sản văn hóa thế giới", image: "/assets/images/tours/hoi-an/hoian.png" },
            { _id: "DES004", code: "DES004", name: "Phú Quốc", description: "Thiên đường biển ngọc đảo ngọc", image: "/assets/images/tours/phu-quoc/phuquoc.png" },
            { _id: "DES005", code: "DES005", name: "Cao Bằng", description: "Thác Bản Giốc và núi rừng Đông Bắc", image: "/assets/images/tours/cao-bang/caobang.png" },
            { _id: "DES006", code: "DES006", name: "Ninh Bình", description: "Di sản thế giới kép Tràng An", image: "/assets/images/tours/ninh-binh/ninhbinh.png" },
            { _id: "DES007", code: "DES007", name: "Đà Nẵng", description: "Thành phố đáng sống bên sông Hàn", image: "/assets/images/tours/da-nang/danang.png" },
            { _id: "DES008", code: "DES008", name: "Hà Giang", description: "Công viên địa chất cao nguyên đá", image: "/assets/images/tours/cao-bang/hagiang.png" },
        ];
        ...
        const tours = [
            {
                ...
                viewCount: 1420,
                bookingCount: 52,
                image: "/assets/images/tours/sapa/thumbnail.jpg",
                thumbnail: "/assets/images/tours/sapa/thumbnail.jpg",
                images: ["/assets/images/tours/sapa/1.jpg", "/assets/images/tours/sapa/2.jpg", "/assets/images/tours/sapa/3.jpg", "/assets/images/tours/sapa/4.jpg"],
                gallery: ["/assets/images/tours/sapa/1.jpg", "/assets/images/tours/sapa/2.jpg", "/assets/images/tours/sapa/3.jpg", "/assets/images/tours/sapa/4.jpg"],
                category: "Vùng Cao",
                ...
                mood: ["phiêu lưu", "thiên nhiên", "thư giãn"],
            ...
            },
            {
                ...
                viewCount: 2150,
                bookingCount: 88,
                image: "/assets/images/tours/ha-long/halong.png",
                thumbnail: "/assets/images/tours/ha-long/halong.png",
                images: ["/assets/images/tours/ha-long/halong.png", "/assets/images/tours/ha-long/kayak.jpg", "/assets/images/tours/ha-long/vinhdisan.jpg", "/assets/images/tours/ha-long/hangdong.jpg"],
                gallery: ["/assets/images/tours/ha-long/halong.png", "/assets/images/tours/ha-long/kayak.jpg", "/assets/images/tours/ha-long/vinhdisan.jpg", "/assets/images/tours/ha-long/hangdong.jpg"],
            ...
            },
            {
                ...
                viewCount: 980,
                bookingCount: 36,
                image: "/assets/images/tours/cao-bang/thumbnail.jpg",
                thumbnail: "/assets/images/tours/cao-bang/thumbnail.jpg",
                images: ["/assets/images/tours/cao-bang/1.jpg", "/assets/images/tours/cao-bang/2.jpg", "/assets/images/tours/cao-bang/3.jpg", "/assets/images/tours/cao-bang/4.jpg"],
                gallery: ["/assets/images/tours/cao-bang/1.jpg", "/assets/images/tours/cao-bang/2.jpg", "/assets/images/tours/cao-bang/3.jpg", "/assets/images/tours/cao-bang/4.jpg"],
                category: "Vùng Cao",
            ...
            },
            {
                ...
                viewCount: 3100,
                bookingCount: 110,
                image: "/assets/images/tours/phu-quoc/thumbnail.jpg",
                thumbnail: "/assets/images/tours/phu-quoc/thumbnail.jpg",
                images: ["/assets/images/tours/phu-quoc/1.jpg", "/assets/images/tours/phu-quoc/2.jpg", "/assets/images/tours/phu-quoc/3.jpg", "/assets/images/tours/phu-quoc/4.jpg"],
                gallery: ["/assets/images/tours/phu-quoc/1.jpg", "/assets/images/tours/phu-quoc/2.jpg", "/assets/images/tours/phu-quoc/3.jpg", "/assets/images/tours/phu-quoc/4.jpg"],
                category: "Du lịch biển",
            ...
            },
            {
                ...
                viewCount: 1650,
                bookingCount: 64,
                image: "/assets/images/tours/hoi-an/hoian.png",
                thumbnail: "/assets/images/tours/hoi-an/hoian.png",
                images: ["/assets/images/tours/hoi-an/hoian.png", "/assets/images/tours/hoi-an/denlong.jpg", "/assets/images/tours/hoi-an/caumuc.jpg", "/assets/images/tours/hoi-an/rau.jpg"],
                gallery: ["/assets/images/tours/hoi-an/hoian.png", "/assets/images/tours/hoi-an/denlong.jpg", "/assets/images/tours/hoi-an/caumuc.jpg", "/assets/images/tours/hoi-an/rau.jpg"],
            ...
            },
            {
                ...
                viewCount: 2800,
                bookingCount: 150,
                image: "/assets/images/tours/ninh-binh/thumbnail.jpg",
                thumbnail: "/assets/images/tours/ninh-binh/thumbnail.jpg",
                images: ["/assets/images/tours/ninh-binh/1.jpg", "/assets/images/tours/ninh-binh/2.jpg", "/assets/images/tours/ninh-binh/3.jpg", "/assets/images/tours/ninh-binh/4.jpg"],
                gallery: ["/assets/images/tours/ninh-binh/1.jpg", "/assets/images/tours/ninh-binh/2.jpg", "/assets/images/tours/ninh-binh/3.jpg", "/assets/images/tours/ninh-binh/4.jpg"],
                category: "Văn Hóa & Di Sản",
